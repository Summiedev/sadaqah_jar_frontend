...
class _MonthlyReviewScreenState extends ConsumerState<MonthlyReviewScreen> with SingleTickerProviderStateMixin {
  ...
  static const _actions = [
    {'value': 'continued', 'label': 'Continue with my goals', 'icon': Icons.check_circle_outline},
    {'value': 'modified', 'label': 'Adjust my goals', 'icon': Icons.tune_rounded},
    {'value': 'replaced', 'label': 'Set new goals', 'icon': Icons.refresh_rounded},
    {'value': 'skipped', 'label': 'Skip this month', 'icon': Icons.skip_next_rounded},
  ];
  ...
  Future<void> _loadData() async {
    try {
      ...
      if (mounted) setState(() { _loading = false; _goalsData = {}; });
    }
  }
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Could not save review: $e'), backgroundColor: Colors.brown),
        );
      }
    }
  }
            ...
            children: [
                ...
                child: Row(
                  children: [
                    ...
                    TextButton(
                      ...
                      child: const Text('Close', style: TextStyle(color: kMuted, fontWeight: FontWeight.w700)),
                    ),
                  ],
                ),
              ),
                    ...
                    : SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Expanded(child: _StatCard(icon: Icons.flag_outlined, label: 'Active goals', value: '$_activeGoals', color: kBronze)),
                                const SizedBox(width: 10),
                                Expanded(child: _StatCard(icon: Icons.check_circle_outline, label: 'Completed', value: '$_completedGoals', color: kSage)),
                              ],
                            ),
                            const SizedBox(height: 10),
                            Row(
                              children: [
                                Expanded(child: _StatCard(icon: Icons.favorite_outline, label: 'Total acts', value: '$_totalActs', color: kBronze)),
                                const SizedBox(width: 10),
                                Expanded(child: _StatCard(icon: Icons.local_fire_department_outlined, label: 'Day streak', value: '$_streak', color: kDanger)),
                              ],
                            ),
                              ...
                              FadeScaleTransition(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: kSage.withValues(alpha: 0.3)),
                                  ),
                                  child: Row(
                                    children: [
                                      Container(
                                        ...
                                        child: const Icon(Icons.celebration_outlined, color: kSage, size: 22),
                                      ),
                                      ...
                                      Expanded(
                                        child: Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            const Text('Goals completed!', style: TextStyle(color: kInk, fontWeight: FontWeight.w800, fontSize: 15)),
                            ...
                            // What's next
                            const Text('What would you like to do next?', style: TextStyle(color: kInk, fontWeight: FontWeight.w800, fontSize: 16)),
                            ...
                            ...List.generate(_actions.length, (index) {
                              ...
                              return Padding(
                                ...
                                child: Material(
                                  ...
                                  child: InkWell(
                                    onTap: () => setState(() => _selectedAction = action['value'] as String),
                                    borderRadius: BorderRadius.circular(16),
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          Icon(action['icon'] as IconData, color: kBronze, size: 22),
                            ...
                            TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Add a note about your month (optional)',
                                filled: true,
                                fillColor: kPaper,
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: _selectedAction != null && !_submitting ? _submitReview : null,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(value, style: TextStyle(color: kInk, fontSize: 24, fontWeight: FontWeight.w700, fontFamily: 'Georgia')),
        ],
      ),
    );
  }
