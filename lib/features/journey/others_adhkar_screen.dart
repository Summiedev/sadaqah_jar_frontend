                          ...
                          ConstrainedBox(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(
                                horizontal: MizanSpacing.sm,
                                vertical: MizanSpacing.xs,
                              ),
    ...
    return Semantics(
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          padding: const EdgeInsets.symmetric(
            horizontal: MizanSpacing.md,
            vertical: MizanSpacing.xs,
          ),
          decoration: BoxDecoration(
            color: active ? tokens.primary : tokens.surfaceContainer,
            borderRadius: BorderRadius.circular(MizanRadii.control),
          ),
          child: Row(
            ...
            children: [
              Icon(
                ...
                size: 16,
                color:
                    active ? tokens.onPrimary : tokens.primary,
              ),
              const SizedBox(width: 6),
              Text(
                label,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: value > 0 ? tokens.successContainer : tokens.surfaceContainer,
          borderRadius: BorderRadius.circular(MizanRadii.control),
        ),
        child: Text(
          '$value',
