...
import 'morning_adhkar_data.dart';

class MorningAdhkarList extends ConsumerStatefulWidget {
  const MorningAdhkarList({super.key});

  @override
  ConsumerState<MorningAdhkarList> createState() => _MorningAdhkarListState();
}

class _MorningAdhkarListState extends ConsumerState<MorningAdhkarList> {
      ...
      children: [
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemCount: MorningAdhkarData.duas.length,
            separatorBuilder: (_, __) => const SizedBox(height: 14),
            itemBuilder: (context, index) {
              final dua = MorningAdhkarData.duas[index];
