...
class TravelAdhkarData {
  ...
  static const List<TravelDua> duas = [
    TravelDua(
      ...
      commonName:
          'Supplication upon mounting an animal or any means of transport',
    ...
    TravelDua(
      ...
      notes:
          'Upon returning, the same supplication is recited with the addition: "Aayiboona, taa\'iboona, \'aabidoona, li-Rabbinaa haamidoon" (We return, repent, worship and praise our Lord)',
    ...
    TravelDua(
      ...
      transliteration:
          'Allaahumma Rabbas-samaawaatis-sab\'i wa maa adhlalna, wa Rabbal-aradheenas-sab\'i wa maa aqlalna, wa Rabbash-shayaateeni wa maa adhlalna, wa Rabbar-riyaahi wa maa dharayn. As\'aluka khayra haadhihil-qaryati wa khayra ahlihaa, wa khayra maa feehaa. Wa a\'oodhu bika min sharrihaa wa sharri ahlihaa, wa sharri maa feehaa.',
      translation:
    ...
    TravelDua(
      ...
      transliteration:
          'Laa ilaaha illallaahu wahdahu laa shareeka lah, lahul-mulku wa lahul-hamd, yuhyee wa yumeetu wa Huwa hayyun laa yamoot, biyadihil-khayr, wa Huwa \'alaa kulli shay\'in Qadeer.',
      translation:
    ...
    TravelDua(
      ...
      transliteration:
          'Astawdi\'ukumullaahal-ladhee laa tadhee\'u wadaa\'i\'uh.',
      translation:
    ...
    TravelDua(
      id: 6,
      arabicOnly:
          'أَسْتَوْدَعُ اللَّهَ دِينَكَ وَأَمَانَتَكَ وَخَوَاتِيمَ عَمَلِكَ',
      transliteration:
    ...
    TravelDua(
      ...
      transliteration:
          'Zawwadakal-laahut-taqwaa, wa ghafara dhanbaka, wa yassara lakal-khayra haythumaa kunt.',
      translation:
          'May Allaah endow you with taqwaa (piety), forgive your sins, and facilitate all good for you, wherever you be.',
    ...
    TravelDua(
      ...
      notes:
          'Jaabir said: while ascending we would say Allaahu akbar, and when descending we would say Subhaanallaah',
    ...
    TravelDua(
      ...
      transliteration:
          'Sami\'a saami\'un bihamdil-laahi wa husni balaa\'ihi \'alaynaa. Rabbanaa saahibnaa wa afdil \'alaynaa, \'aa\'idham-billaahi minan-naar.',
      translation:
          'May a witness bear witness to our praise of Allaah for His favours and bounties upon us. Our Lord, accompany us and show favour upon us. I take refuge in Allaah from the Fire.',
    ...
    TravelDua(
      ...
      notes:
          'Ibn \'Umar reported that the Messenger of Allaah, on return from a battle or from performing the pilgrimage, would say this at every high point',
    ...
    TravelDua(
      ...
      transliteration:
          'Laa ilaaha illallaahu wahdahu laa shareeka lah, lahul-mulku wa lahul-hamdu, wa Huwa \'alaa kulli shay\'in Qadeer. Aayiboona, taa\'iboona, \'aabidoona, saajidoona, li-Rabbinaa haamidoon. Sadaqal-laahu wa\'dah, wa nasara \'abdah, wa hazamal-ahzaaba wahdah.',
      translation:
          'None has the right to be worshipped except Allaah, alone, without partner. To Him belongs all sovereignty and praise, and He is over all things omnipotent. We return, repent, worship, prostrate, and praise our Lord. Allaah fulfilled His promise, aided His servant, and single-handedly defeated the allies.',
