...
import 'evening_adhkar_data.dart';

class EveningAdhkarList extends ConsumerStatefulWidget {
  const EveningAdhkarList({super.key});

  @override
  ConsumerState<EveningAdhkarList> createState() => _EveningAdhkarListState();
}

class _EveningAdhkarListState extends ConsumerState<EveningAdhkarList> {
      ...
      children: [
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemCount: EveningAdhkarData.duas.length,
            separatorBuilder: (_, __) => const SizedBox(height: 14),
            itemBuilder: (context, index) {
              final dua = EveningAdhkarData.duas[index];
