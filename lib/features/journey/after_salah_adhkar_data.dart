...
class AfterSalahAdhkarData {
  ...
  static const List<AfterSalahDua> duas = [
    ...
    AfterSalahDua(
      ...
      transliteration:
          'Laa ilaaha illallaahu wahdahu laa shareeka lah, lahul-mulku wa lahul-hamdu wa Huwa \'alaa kulli shay\'in Qadeer. Allaahumma laa maani\'a limaa a\'tayta, wa laa mu\'tiya limaa mana\'ta, wa laa yanfa\'u dhal-jaddi minkal-jadd.',
      translation:
          'None has the right to be worshipped except Allaah, alone, without partner, to Him belongs all sovereignty and praise, and He is over all things omnipotent. O Allaah, none can withhold what You give, and none can give what You withhold, and the might of the mighty person cannot benefit him against You.',
    ...
    AfterSalahDua(
      ...
      notes:
          'First of four dhikr said after every obligatory prayer; whoever recites the full set will have sins forgiven even if like the foam of the sea',
    ...
    AfterSalahDua(
      ...
      notes:
          'Recited once after each prayer, and three times after Fajr and Maghrib',
    ...
    AfterSalahDua(
      ...
      notes:
          'The Prophet took the hand of Mu\'aadh and said this, instructing him to never omit it after every prayer',
    ...
    AfterSalahDua(
      ...
      transliteration:
          'Allaahumma Rabba haadhihid-da\'watit-taammah, was-salaatil-qaa\'imah, aati Muhammadanil-waseelata wal-fadeelah, wab\'ath-hu maqaamam mahmoodanil-ladhee wa\'adtah.',
      translation:
          'O Allaah, Lord of this perfect call and established prayer, grant Muhammad the intercession and favour, and raise him to the honoured station which You have promised him.',
      notes:
          'Recited after the adhan, but also transmitted among after-prayer remembrances in some narrations',
      repetition: 'Once',
      source: 'al-Bukhari',
    ),
    AfterSalahDua(
      ...
      transliteration:
          'Allaahumma innee as\'aluka \'ilman naafi\'an, wa rizqan tayyibaa, wa \'amalan mutaqabbalaa.',
      translation:
          'O Allaah, I ask You for beneficial knowledge, good provision, and acceptable deeds.',
