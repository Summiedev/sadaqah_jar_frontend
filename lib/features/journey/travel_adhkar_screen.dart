...
class TravelAdhkarList extends ConsumerStatefulWidget {
  const TravelAdhkarList({super.key});

  @override
  ConsumerState<TravelAdhkarList> createState() => _TravelAdhkarListState();
}

class _TravelAdhkarListState extends ConsumerState<TravelAdhkarList> {
        ...
        Expanded(
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              final dua = TravelAdhkarData.duas[index];
