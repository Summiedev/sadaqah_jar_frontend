...
class PressableSpring extends StatefulWidget {
  const PressableSpring({super.key, required this.child, this.onTap, this.scale = .975, this.borderRadius});
  final Widget child;
  final VoidCallback? onTap;
  final double scale;
  final BorderRadius? borderRadius;
  @override State<PressableSpring> createState() => _PressableSpringState();
}
...
class FocusGlow extends StatefulWidget {
  ...
  final Widget child;
  final double radius;
  @override State<FocusGlow> createState() => _FocusGlowState();
}
