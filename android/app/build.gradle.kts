...
// Load signing configuration from key.properties (gitignored, never committed)
...
android {
    ...
    buildTypes {
        release {
            ...
            // If key.properties is missing, the release build will fail with a clear
            // signing error rather than silently using debug keys.
