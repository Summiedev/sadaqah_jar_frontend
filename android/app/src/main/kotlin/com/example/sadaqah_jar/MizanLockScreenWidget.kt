...
class MizanLockScreenWidget : AppWidgetProvider() {
    ...
    companion object {
        internal fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            val text = data.getString("daily_text", "Remember Allah with much remembrance.")
            val source = data.getString("daily_source", "Quran 33:41-42")
            val shortText = data.getString("daily_short", "Remember Allah often")
